...
> **Arranque:** T9 ✅ → T22 ✅ → T28 ✅ → T21+T11 ✅ → T12 ✅ → T18 ✅ → T15+T19 ✅ → T26 ✅ → T24 ✅ → T25 ✅ → T23 ✅ → T8 ✅ → T1 ✅ → T2 ✅ → T6 ✅ → T10 ✅ → T17 ✅ → T13 ✅ → T5 ✅ → T7 ✅ → T16 ✅ → T3 ✅ → **T27 ✅** (revisión del dueño hecha) → **T4 opción A ✅ como MVP** (2026-07-15, falta su arte F4). Queda **T14** (lanzamiento: cuenta Play + decisión de publicar) y el arte de T4/T5/T3.
...
| T4 | [Endgame / generaciones](04-endgame-generaciones.md) | El juego se acaba en ~2 semanas | L | 🟡 opción E hecha (2026-07-03: ceremonia de evolución) + **opción A hecha como MVP (2026-07-15)**: retirar al Maestro → cría Gen+1 + vitrina de legado (`AccountService.RetireAsync`, `POST me/retire`, migración `AddPetGenerations`; botón/insignia/legado en Perfil; solo prestigio, sin tocar economía; 134 tests). Falta: estatua en diorama (arte F4), verificación del dueño; B/C/D siguen pendientes |
...
| T27 | [UX: recorrido de la app](27-ux-recorrido-app.md) | Fricción real navegando (mejor en sesión con el dueño) | M | ✅ hecho (pre-pase autónomo 2026-07-03: checklist objetivo + fix del cold-start de PetDetailPage) + **revisión visual del dueño HECHA ×2 (confirmado 2026-07-15)** — T27 cerrado |
| T31 | [Intuitividad + animaciones](31-intuitividad-animaciones.md) | La app no enseñaba sus reglas (cero onboarding, ~10 conceptos sin explicar) y el feedback era texto (51 toasts vs 20 animaciones) | M | ✅ hecho (2026-07-18): 9 ítems — tween de barras, onboarding 3 tarjetas + 1ª visita por pestaña, "tap = explicación" (InfoOverlay), números flotantes, ritual/evolución/compra celebradas, aviso previo de cristalización, "¿Cómo se juega?" en Ajustes. Compila; falta pasada visual del dueño |
